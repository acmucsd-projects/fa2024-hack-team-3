...
const AccountHeader = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const checkResponse = await axios.post(
        "https://fa2024-hack-team-3-bwgb.onrender.com/api/users/check-username",
      ...
      const updateResponse = await axios.patch(`https://fa2024-hack-team-3-bwgb.onrender.com/api/users/${userInfo.id}`, 
        { username: newUsername }
      );
  ...
  const handleFileChange = async (event) => {
    ...
    try {
      const response = await axios.post(`https://fa2024-hack-team-3-bwgb.onrender.com/api/users/${userInfo.id}/upload`, formData, {
        headers: {
