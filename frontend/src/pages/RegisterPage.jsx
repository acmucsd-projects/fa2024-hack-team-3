...
const RegisterPage = () => {
    ...
    const validateField = async (name, value) => {
        switch (name) {
            case "username":
                ...
                try {
                    const response = await axios.post("https://fa2024-hack-team-3-bwgb.onrender.com/api/users/check-username", { username: value });
            ...
            case "email":
                ...
                try {
                    const response = await axios.post("https://fa2024-hack-team-3-bwgb.onrender.com/api/users/check-email", { emailAddress: value });
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await axios.post("https://fa2024-hack-team-3-bwgb.onrender.com/api/users", {
                username,
                emailAddress: email,
                password,
                courses,
